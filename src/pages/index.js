      ...
      <main>
        <div className="hero tw:relative tw:h-192 tw:pt-0 tw:overflow-hidden">
          ...
          <div className="tw:container tw:mx-auto tw:z-10">
            <div className="tw:flex tw:flex-col tw:lg:flex-row tw:lg:justify-between tw:lg:items-center">
              <div className="tw:flex-[.8] tw:2xl:flex-[.6] tw:p-6 tw:lg:p-3">
                <h1
                  className={clsx(
                    'tw:inline-block tw:text-5xl tw:xl:text-6xl tw:text-left tw:rounded-2xl tw:backdrop-blur-sm tw:lg:backdrop-blur',
                    styles.heroTitle,
                  )}
                >
                ...
                <div className="tw:flex tw:gap-3">
                  <Link
                    ...
                    className="tw:btn tw:btn-primary! tw:hover:-translate-y-0.75"
                  >
                    <Translate id="home.getstarted">Get Started →</Translate>
                  </Link>
                  <Link
                    to="https://github.com/chaos-mesh/chaos-mesh"
                    className="tw:btn tw:btn-neutral! tw:gap-2 tw:dark:glass tw:hover:-translate-y-0.75"
                  >
              ...
              <div className="tw:lg:max-xl:w-125 tw:p-6 tw:lg:p-3">
                <h2 className="tw:inline-block tw:text-base tw:lg:text-lg tw:font-semibold tw:rounded-2xl tw:backdrop-blur-sm tw:lg:backdrop-blur">
...
helm install chaos-mesh chaos-mesh/chaos-mesh -n=chaos-mesh --create-namespace`}
        ...
        <div className="hero">
          <div className="tw:container tw:mx-auto tw:max-lg:px-4 tw:text-center">
            <h2 className="tw:text-lg">
              <Translate id="home.whoisusing">Users of Chaos Mesh</Translate>
            </h2>
            <div className="tw:max-md:overflow-x-auto tw:dark:invert tw:dark:saturate-0">
              <div className="row tw:max-md:w-[1280px]">
                {whoIsUsing.map((w) => (
        ...
        <div className="hero">
          <div className="tw:container tw:mx-auto tw:max-lg:px-4">
            ...
            <div className="tw:grid tw:gap-8 tw:lg:grid-rows-2 tw:lg:grid-cols-6">
              <Features />
            </div>
          </div>
        </div>
        ...
        <div className="hero">
          <div className="tw:container tw:mx-auto tw:max-lg:px-4">
            ...
            <img
              className={clsx(
                'tw:block tw:mx-auto tw:select-none tw:dark:invert-[.85] tw:dark:saturate-0',
            ...
            <div className="tw:grid tw:gap-8 tw:lg:grid-cols-3 tw:my-12">
              <CodeGrid />
            </div>
          </div>
        </div>
        ...
        <div className="hero tw:relative">
          <div className="tw:absolute tw:top-[-50px] tw:left-0 tw:md:top-[-100px] tw:xl:top-[-200px] tw:w-full">
        ...
        <div className="hero">
          <div className="tw:container tw:mx-auto tw:max-lg:px-4">
            <div className="tw:flex tw:flex-col tw:lg:flex-row tw:lg:items-center tw:gap-8">
              <div className={clsx('tw:relative tw:flex-1 tw:flex tw:items-center tw:overflow-hidden tw:xl:h-[640px]')}>
                <img className="tw:absolute tw:w-[90%]" src="/img/home/chaosd-bg.svg" />
                <div className="tw:flex tw:justify-center tw:items-center tw:xl:w-[75%] tw:lg:h-full">
                  <ChaosdFeatures />
                </div>
              </div>
              <div className="tw:flex-[1.5] tw:z-10">
                ...
                <p className="tw:lg:text-lg tw:font-medium">
                  <Translate
                    ...
                    values={{
                      link: (
                        <Link className="tw:underline" to="/docs/simulate-physical-machine-chaos">
        ...
        <div className="hero">
          <div className="tw:container tw:mx-auto tw:max-lg:px-4">
            ...
            <div className="tw:grid tw:lg:grid-cols-3 tw:gap-8 tw:mb-12 tw:lg:w-[80%] tw:lg:mx-auto">
              <Card>
                <IconGithub className="tw:w-12 tw:h-12 tw:dark:fill-white" />
                <p>
              ...
              <Card>
                <IconHelp className="tw:w-12 tw:h-12 tw:dark:fill-white" />
                <p>
