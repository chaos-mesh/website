...
Our support window covers the **two latest releases**. Given that we produce a new final release **about every six months**, each release branch is typically supported for about a year.
