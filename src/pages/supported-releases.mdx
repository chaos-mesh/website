...
Our support window is **six months** for each release branch. The support window corresponds to the **two latest releases**, given that we produce a new final release **about every six months**.

For this, we offer two types of support:
...
You can request support from the community on CNCF Slack (in the [#project-chaos-mesh](https://cloud-native.slack.com/archives/C0193VAV272) channel), or through the [GitHub Discussions](https://github.com/chaos-mesh/chaos-mesh/discussions).
...
For enhancements or bug fixes, we make a new patch release as needed.
