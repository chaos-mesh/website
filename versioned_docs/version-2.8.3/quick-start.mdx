...
Given the widespread use and mature ecosystem of [Helm](https://helm.sh/), we no longer recommend managing Chaos Mesh via scripts. So please refer to [Installation using Helm](production-installation-using-helm.mdx) for installation in test or production environments.
