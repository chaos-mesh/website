...
Here we use TiDB cluster as an example. Suppose we already install the [TiDB cluster](https://docs.pingcap.com/tidb-in-kubernetes/stable/) and [Chaos Mesh](../user_guides/installation.md)
...
Chaos Mesh provides [`NetworkChaos`](../chaos_experiments/networkchaos.md) to inject network latency,
