...
| `expiration` | None | expiration | The specified key will be expired after `expiration` arrives | string | Default value: `"0"`. The string must be in the format supported by `time.Duration`. |
