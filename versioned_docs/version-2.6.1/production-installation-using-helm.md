...
To install a specific version of Chaos Mesh, add the `--version x.y.z` parameter after `helm install/upgrade`. For example, `helm install chaos-mesh chaos-mesh/chaos-mesh -n=chaos-mesh --version 2.1.0`.
