...
| device             | d            | Name of the impacted network interface card                                                                                 | String, such as “eth0”. The value is mandatory.                                                                           |
...
| hostname           | H            | The hostname impacted by traffic                                                                                            | String, such as "chaos-mesh.org".                                                                                         |
...
| device             | d            | The name of impacted network interface card                                                                                 | String, such as “eth0”. The value must be set.                                                                            |
