...
* Use WebAssembly (Wasm). When you need to call chaos experiment logic, just call the Wasm program. See Vector's [WASM Transform](https://webcache.googleusercontent.com/search?q=cache:aR1ZIlTwz9sJ:https://vector.dev/docs/r[…]uration/transforms/wasm/+&cd=1&hl=zh-CN&ct=clnk&gl=jp).
